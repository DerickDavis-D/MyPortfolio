...
const SkillCard = ({ icon, skillName, description, progress }) => {
  return (
    <div className='bg-white rounded-2xl border border-primary p-4'>
      <div className='flex gap-3'>
        <div className='w-10 h-10 flex items-center justify-center bg-gradient-to-b from-[#ADD8E6] to-[#ffffff] rounded-[7px]'>{icon}</div>
